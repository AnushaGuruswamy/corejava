package com.Anusha.typeCasting;
...
public class TypeCasting {
	...
	public void tcChar() {
		...
		byte tcByte = (byte)charValue;
		System.out.println(tcByte);
		int tcInt = (short)charValue;
		System.out.println(tcInt);
		short tcShort = (short)charValue;
		System.out.println(tcShort);
		long tcLong = (long)charValue;
		System.out.println(tcLong);
		float tcFloat = (float)charValue;
		System.out.println(tcFloat);
		char tcChar = (char)charValue;
		System.out.println(tcChar);
	}
}
