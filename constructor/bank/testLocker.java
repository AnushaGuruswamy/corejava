...
public class testLocker {
		...
		public static void main(String []nag) {
			...
			Locker locker4=new Locker("DBS Bank","M G Road","Anusha",26546,9584256987l,256836583254l,"PNHG2348B");
			System.out.println(locker4.printAll());
			Locker locker5=new Locker("DBS Bank","M G Road","Nagesh",58746,9739538340l,485147965145l,"BKID5874K");
			System.out.println(locker5.printAll());
		}
